/*
    This program defines a matrix data type and some basic functions alongside it.
    Determinate, Transpose, Element-wise multiplication, and Inverse functions are included.
*/
